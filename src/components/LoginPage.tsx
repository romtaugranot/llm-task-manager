        ...
        >
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to access your personalized task manager</p>
            </div>

            <motion.button
              onClick={handleGoogleLogin}
              disabled={isLoading}
              className={`w-full flex items-center justify-center space-x-3 px-6 py-4 border border-gray-300 rounded-xl font-medium transition-all ${
                isLoading
